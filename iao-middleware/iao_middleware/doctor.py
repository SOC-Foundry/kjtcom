"""iao_middleware.doctor - Shared health checks for IAO environments.
...
def _check_manifest():
    try:
        root = find_project_root()
        # In kjtcom, middleware is at iao-middleware/
        middleware_home = root / "iao-middleware"
