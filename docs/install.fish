...
echo ""
echo "5. Generate Firebase CI Token (required for auto-deploy):"
echo "     firebase login:ci"
echo "     # Copy the token and save to:"
echo "     echo \"FIREBASE_TOKEN=your_token_here\" > ~/.config/firebase-ci-token.txt"
echo ""

if test $HAS_NVIDIA -eq 0
    echo "6. IMPORTANT - No NVIDIA GPU detected on this machine."
